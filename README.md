...
```javascript
mskmax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmax@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-mskmax/tags). For example,

```javascript
mskmax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmax@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var mskmax = require( 'path/to/vendor/umd/stats-strided-mskmax/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmax@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-mskmax.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-mskmax

[test-image]: https://github.com/stdlib-js/stats-strided-mskmax/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-mskmax/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-mskmax/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-mskmax?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-mskmax.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-mskmax/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-mskmax/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-mskmax/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-mskmax/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-mskmax/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-mskmax/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-mskmax/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-mskmax/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-mskmax/main/LICENSE
