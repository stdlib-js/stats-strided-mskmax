...
```javascript
import mskmax from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmax@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmax@v0.1.0-esm/index.mjs';
```
